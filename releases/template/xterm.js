...
var Renderer = (function (_super) {
    ...
    Renderer.prototype.onResize = function (cols, rows) {
        ...
        this._terminal.screenElement.style.width = this.dimensions.canvasWidth/20 + "px";
        this._terminal.screenElement.style.height = this.dimensions.canvasHeight*1.2 + "px";
        this.emit('resize', {
